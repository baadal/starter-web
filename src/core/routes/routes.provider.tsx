...
export const routesData: RouteData[] = [
  {
    ...
    component: loadable(() => import(/* webpackChunkName: "about" */ 'src/components/pages/about/about.component')),
    source: routes.about.source,
  },
  {
    path: routes.cssStylesDemo.path,
    component: loadable(() => import(/* webpackChunkName: "demo" */ 'src/components/pages/demo/css-styles/css-styles.component')),
    source: routes.cssStylesDemo.source,
  },
  {
    path: routes.cssInJsDemo.path,
    component: loadable(() => import(/* webpackChunkName: "demo" */ 'src/components/pages/demo/css-in-js/css-in-js.component')),
    source: routes.cssInJsDemo.source,
  },
  {
    path: routes.stateStoreDemo.path,
    component: loadable(() => import(/* webpackChunkName: "demo" */ 'src/components/pages/demo/state-store/state-store.component')), // eslint-disable-line
    source: routes.stateStoreDemo.source,
  },
  {
    path: routes.fibonacciDemo.path,
    component: loadable(() => import(/* webpackChunkName: "demo" */ 'src/components/pages/demo/fibonacci/fibonacci.component')),
    source: routes.fibonacciDemo.source,
  },
  {
    path: routes.esnextDemo.path,
    component: loadable(() => import(/* webpackChunkName: "demo" */ 'src/components/pages/demo/esnext/esnext.component')),
    source: routes.esnextDemo.source,
  },
  {
    path: routes.home.path,
    component: loadable(() => import(/* webpackChunkName: "home" */ 'src/components/pages/home/home.component')),
