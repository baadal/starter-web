...
import StateStore from 'app/utils/state-store';
import { StateStoreDemoData } from 'app/model/pagedata.model';
...
class StateStoreDemo extends React.Component<StateStoreDemoProps, StateStoreDemoState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 className={common.pageTitle} dangerouslySetInnerHTML={{ __html: title }} />
        <div>
